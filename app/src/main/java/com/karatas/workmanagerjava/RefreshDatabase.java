package com.karatas.workmanagerjava;
...
public class RefreshDatabase extends Worker {
    ...
    private void refreshDatabase(int myNumber) {
        SharedPreferences sharedPreferences = myContext.getSharedPreferences("com.karatas.workmanagerjava",Context.MODE_PRIVATE);
